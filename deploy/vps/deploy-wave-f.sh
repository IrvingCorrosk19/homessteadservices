...
test -f /opt/apps/homestead/src/lib/analytics-service.ts
test -f /opt/apps/homestead/src/app/admin/clientes/page.tsx
...
curl -sS -o /dev/null -w "admin:%{http_code}\n" http://127.0.0.1:3091/admin || true
curl -sS -o /dev/null -w "clientes:%{http_code}\n" http://127.0.0.1:3091/admin/clientes || true
