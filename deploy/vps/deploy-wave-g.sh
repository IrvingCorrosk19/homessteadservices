...
test -f /opt/apps/homestead/src/lib/copilot/service.ts
test -f /opt/apps/homestead/src/app/admin/copilot/page.tsx
...
curl -sS -o /dev/null -w "copilot:%{http_code}\n" http://127.0.0.1:3091/admin/copilot || true
