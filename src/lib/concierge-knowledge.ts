import { contact, formServices, isOfficialWhatsAppEnabled, site, type ServiceSlug } from "@/lib/site";
...
export function conciergeKnowledge() {
  ...
  return {
    ...
    whatsappConfigured: isOfficialWhatsAppEnabled() && contact.whatsapp.isConfigured,
